...
const apps = [
  ...
  },
  {
    ...
    description: '연간 조회수 6,025만 구단 채널 운영 경험 기반 분기 성과 리포트 자동화 + 댓글 분석 툴. CSV·YouTube URL 입력으로 KPI 대시보드·댓글 감성·키워드·시청자 요구사항까지 즉시 파악. *데모 버전',
    log: '보고서 만들고 댓글 여론 파악까지. 채널 운영 루틴을 전부 시스템으로.',
    tags: ['Python', 'Chart.js', 'YouTube API', 'SheetJS', 'Vercel'],
    color: '#EFF6FF',
