...
const apps = [
  {
    ...
    category: 'work',
    animation: 'flow',
    description: '매일 05:30 자동 실행. 뉴스·SNS·커뮤니티를 한 번에 수집해 Notion 리포트로 정리하고, 담당자에게 알림까지 자동 발송. 구단 홍보팀 아침 브리핑 업무 완전 자동화.',
    log: '아침마다 손으로 긁던 스크랩 업무, 전부 없애버림',
    tags: ['Python', 'GitHub Actions', 'Notion API', 'Naver API', 'Telegram Bot'],
    color: '#FFF7ED',
    url: 'https://www.notion.so/35ef470c09f7802aba25d2a5d933e94b',
    flow: [
      { icon: '📰', label: '뉴스·SNS\n커뮤니티 수집' },
      { icon: '📊', label: '분류·\n정리' },
      { icon: '📋', label: 'Notion\n저장' },
  ...
  },
  {
    ...
    category: 'work',
    animation: 'terminal',
    description: '구독자 36.7만 구단 채널 포함, 2개 채널의 주간 지표 입력 업무를 API 자동화로 완전 제거. 절약한 시간을 기획에 재투자.',
  ...
  },
  {
    ...
    description: '채널 총괄 운영 경험을 AI 컨설팅 툴로 패키징. 데이터 업로드만 하면 채널 진단부터 콘텐츠 전략까지 자동화.',
    log: '내 채널 데이터 넣으면 AI가 맞춤 컨설팅을 해줌',
  ...
  },
  {
    id: 14,
    emoji: '📊',
    title: '유튜브 채널 성과 분석 리포트',
    year: '2026.05',
    category: 'work',
    video: '/screenshots/14.mov',
    description: '연간 조회수 6,025만 구단 채널 운영 경험을 기반으로 만든 분기 성과 보고서 자동화. CSV 업로드 한 번으로 KPI 대시보드 즉시 생성. *데모 버전',
    log: '매번 수동으로 만들던 성과 보고서를 시스템으로 만듦. CSV 업로드하면 자동 분석! *데모 버전',
    tags: ['Python', 'Chart.js', 'Vercel', 'GitHub'],
    color: '#EFF6FF',
    url: 'https://mj-yt-report-demo.vercel.app/',
  },
  {
    id: 10,
    emoji: '☁️',
    ...
    category: 'work',
    animation: 'flow',
    description: '촬영 완료 영상을 수동으로 올리던 반복 업무를 자동화. 파일 저장 즉시 팀 공유 클라우드에 무인 배포.',
  ...
  },
  {
    ...
    year: '2026.04',
    category: 'work',
    description: '매일 반복되는 첨부파일 수신·분류·전달 업무를 Gmail API로 완전 자동화. 사람이 없어도 타 부서에 정확히 배달.',
  ...
  },
  {
    ...
    category: 'work',
    format: 'notion',
    description: '구독자 36.7만 채널의 월간 편성을 팀 전체가 실시간 공유하는 협업 시스템. 기획에서 게시까지 누락 없이 관리.',
